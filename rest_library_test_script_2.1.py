...
def run_tests(server_url, username, password):
    ...
    # Actual tests
    default = TableauRestApi(server_url, username, password, 'default')
...
def create_test_site(d, server_url, username, password, logger):
    ...
    try:
        ...
        test_site = TableauRestApi(server_url, username, password, delete_login_content_url)
    ...
    test_site = TableauRestApi(server_url, username, password, new_site_content_url)
    test_site.enable_logging(logger)
